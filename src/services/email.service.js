...
const sendEmail = async (sendTo, type, subject = null, vars = {}) => {
  try {
    ...
    const fromName = emailContent.from_name || settingsObj["site_name"] || "Beaudeluxe";
    const fromEmail = settingsObj["smtp_username"] || settingsObj["from_email"];
    ...
    const isSecure = parseInt(settingsObj["smtp_port"]) === 465;
